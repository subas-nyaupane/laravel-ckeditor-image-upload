...
~~~
Route::post('/image-upload', [\App\Http\Controllers\Backend\ImageController::class, 'store'])
    ->name('image_upload');
~~~ 
...
### \App\Http\Controllers\Backend\ImageController.php
...
class ImageController extends Controller
{
    public function store(Request $request)
    {
        ...
        Storage::putFileAs('public/ckeditor/', new File($file), $filename);
